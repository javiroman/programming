...
%% Generated by gpb_compile version 3.19.0 on {{2016,7,29},{18,45,9}}

-ifndef(scheduler_pb).
-define(scheduler_pb, true).

-define(scheduler_pb_gpb_version, "3.19.0").
...
-ifndef('MESOS.V1.SCHEDULER.CALL.REQUEST_PB_H').
-define('MESOS.V1.SCHEDULER.CALL.REQUEST_PB_H', true).
...
-ifndef('MESOS.V1.SCHEDULER.CALL.MESSAGE_PB_H').
-define('MESOS.V1.SCHEDULER.CALL.MESSAGE_PB_H', true).
...
-ifndef('MESOS.V1.SCHEDULER.CALL.RECONCILE.TASK_PB_H').
-define('MESOS.V1.SCHEDULER.CALL.RECONCILE.TASK_PB_H', true).
...
-ifndef('MESOS.V1.SCHEDULER.CALL.RECONCILE_PB_H').
-define('MESOS.V1.SCHEDULER.CALL.RECONCILE_PB_H', true).
-record('mesos.v1.scheduler.Call.Reconcile',
        {tasks = []                     % = 1, [{msg,'mesos.v1.scheduler.Call.Reconcile.Task'}]
        }).
-endif.

-ifndef('MESOS.V1.SCHEDULER.CALL.ACKNOWLEDGE_PB_H').
-define('MESOS.V1.SCHEDULER.CALL.ACKNOWLEDGE_PB_H', true).
...
-ifndef('MESOS.V1.SCHEDULER.CALL.SHUTDOWN_PB_H').
-define('MESOS.V1.SCHEDULER.CALL.SHUTDOWN_PB_H', true).
...
-ifndef('MESOS.V1.SCHEDULER.CALL.KILL_PB_H').
-define('MESOS.V1.SCHEDULER.CALL.KILL_PB_H', true).
-record('mesos.v1.scheduler.Call.Kill',
        {task_id,                       % = 1, {msg,'mesos.v1.TaskID'}
         agent_id,                      % = 2, {msg,'mesos.v1.AgentID'} (optional)
         kill_policy                    % = 3, {msg,'mesos.v1.KillPolicy'} (optional)
        }).
-endif.
...
-ifndef('MESOS.V1.SCHEDULER.CALL.DECLINEINVERSEOFFERS_PB_H').
-define('MESOS.V1.SCHEDULER.CALL.DECLINEINVERSEOFFERS_PB_H', true).
-record('mesos.v1.scheduler.Call.DeclineInverseOffers',
        {inverse_offer_ids = [],        % = 1, [{msg,'mesos.v1.OfferID'}]
         filters                        % = 2, {msg,'mesos.v1.Filters'} (optional)
        }).
-endif.

-ifndef('MESOS.V1.SCHEDULER.CALL.ACCEPTINVERSEOFFERS_PB_H').
-define('MESOS.V1.SCHEDULER.CALL.ACCEPTINVERSEOFFERS_PB_H', true).
-record('mesos.v1.scheduler.Call.AcceptInverseOffers',
        {inverse_offer_ids = [],        % = 1, [{msg,'mesos.v1.OfferID'}]
         filters                        % = 2, {msg,'mesos.v1.Filters'} (optional)
        }).
-endif.

-ifndef('MESOS.V1.SCHEDULER.CALL.DECLINE_PB_H').
-define('MESOS.V1.SCHEDULER.CALL.DECLINE_PB_H', true).
...
-ifndef('MESOS.V1.SCHEDULER.CALL.ACCEPT_PB_H').
-define('MESOS.V1.SCHEDULER.CALL.ACCEPT_PB_H', true).
...
-ifndef('MESOS.V1.SCHEDULER.CALL.SUBSCRIBE_PB_H').
-define('MESOS.V1.SCHEDULER.CALL.SUBSCRIBE_PB_H', true).
-record('mesos.v1.scheduler.Call.Subscribe',
        {framework_info                 % = 1, {msg,'mesos.v1.FrameworkInfo'}
        }).
-endif.

-ifndef('MESOS.V1.SCHEDULER.CALL_PB_H').
-define('MESOS.V1.SCHEDULER.CALL_PB_H', true).
-record('mesos.v1.scheduler.Call',
        {framework_id,                  % = 1, {msg,'mesos.v1.FrameworkID'} (optional)
         type,                          % = 2, {enum,'mesos.v1.scheduler.Call.Type'} (optional)
         ...
         accept_inverse_offers,         % = 13, {msg,'mesos.v1.scheduler.Call.AcceptInverseOffers'} (optional)
         decline_inverse_offers,        % = 14, {msg,'mesos.v1.scheduler.Call.DeclineInverseOffers'} (optional)
...
-ifndef('MESOS.V1.SCHEDULER.EVENT.UPDATE_PB_H').
-define('MESOS.V1.SCHEDULER.EVENT.UPDATE_PB_H', true).
-record('mesos.v1.scheduler.Event.Update',
        {status                         % = 1, {msg,'mesos.v1.TaskStatus'}
        }).
-endif.

-ifndef('MESOS.V1.SCHEDULER.EVENT.ERROR_PB_H').
-define('MESOS.V1.SCHEDULER.EVENT.ERROR_PB_H', true).
-record('mesos.v1.scheduler.Event.Error',
        {message                        % = 1, string
        }).
-endif.

-ifndef('MESOS.V1.SCHEDULER.EVENT.FAILURE_PB_H').
-define('MESOS.V1.SCHEDULER.EVENT.FAILURE_PB_H', true).
...
-ifndef('MESOS.V1.SCHEDULER.EVENT.MESSAGE_PB_H').
-define('MESOS.V1.SCHEDULER.EVENT.MESSAGE_PB_H', true).
...
-ifndef('MESOS.V1.SCHEDULER.EVENT.RESCINDINVERSEOFFER_PB_H').
-define('MESOS.V1.SCHEDULER.EVENT.RESCINDINVERSEOFFER_PB_H', true).
-record('mesos.v1.scheduler.Event.RescindInverseOffer',
        {inverse_offer_id               % = 1, {msg,'mesos.v1.OfferID'}
        }).
-endif.

-ifndef('MESOS.V1.SCHEDULER.EVENT.RESCIND_PB_H').
-define('MESOS.V1.SCHEDULER.EVENT.RESCIND_PB_H', true).
...
-ifndef('MESOS.V1.SCHEDULER.EVENT.INVERSEOFFERS_PB_H').
-define('MESOS.V1.SCHEDULER.EVENT.INVERSEOFFERS_PB_H', true).
-record('mesos.v1.scheduler.Event.InverseOffers',
        {inverse_offers = []            % = 1, [{msg,'mesos.v1.InverseOffer'}]
        }).
-endif.

-ifndef('MESOS.V1.SCHEDULER.EVENT.OFFERS_PB_H').
-define('MESOS.V1.SCHEDULER.EVENT.OFFERS_PB_H', true).
-record('mesos.v1.scheduler.Event.Offers',
        {offers = []                    % = 1, [{msg,'mesos.v1.Offer'}]
        }).
-endif.

-ifndef('MESOS.V1.SCHEDULER.EVENT.SUBSCRIBED_PB_H').
-define('MESOS.V1.SCHEDULER.EVENT.SUBSCRIBED_PB_H', true).
...
-ifndef('MESOS.V1.SCHEDULER.EVENT_PB_H').
-define('MESOS.V1.SCHEDULER.EVENT_PB_H', true).
-record('mesos.v1.scheduler.Event',
        {type,                          % = 1, {enum,'mesos.v1.scheduler.Event.Type'} (optional)
         subscribed,                    % = 2, {msg,'mesos.v1.scheduler.Event.Subscribed'} (optional)
         offers,                        % = 3, {msg,'mesos.v1.scheduler.Event.Offers'} (optional)
         inverse_offers,                % = 9, {msg,'mesos.v1.scheduler.Event.InverseOffers'} (optional)
         rescind,                       % = 4, {msg,'mesos.v1.scheduler.Event.Rescind'} (optional)
         rescind_inverse_offer,         % = 10, {msg,'mesos.v1.scheduler.Event.RescindInverseOffer'} (optional)
