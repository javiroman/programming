...
%% Generated by gpb_compile version 3.19.0 on {{2016,7,29},{18,45,5}}

-ifndef(executor_pb).
-define(executor_pb, true).

-define(executor_pb_gpb_version, "3.19.0").
...
-ifndef('MESOS.V1.EXECUTOR.CALL.MESSAGE_PB_H').
-define('MESOS.V1.EXECUTOR.CALL.MESSAGE_PB_H', true).
-record('mesos.v1.executor.Call.Message',
        {data                           % = 2, bytes
        }).
-endif.
...
-ifndef('MESOS.V1.EXECUTOR.CALL.UPDATE_PB_H').
-define('MESOS.V1.EXECUTOR.CALL.UPDATE_PB_H', true).
-record('mesos.v1.executor.Call.Update',
...
-ifndef('MESOS.V1.EXECUTOR.CALL.SUBSCRIBE_PB_H').
-define('MESOS.V1.EXECUTOR.CALL.SUBSCRIBE_PB_H', true).
-record('mesos.v1.executor.Call.Subscribe',
        {unacknowledged_tasks = [],     % = 1, [{msg,'mesos.v1.TaskInfo'}]
         unacknowledged_updates = []    % = 2, [{msg,'mesos.v1.executor.Call.Update'}]
        }).
-endif.

-ifndef('MESOS.V1.EXECUTOR.CALL_PB_H').
-define('MESOS.V1.EXECUTOR.CALL_PB_H', true).
-record('mesos.v1.executor.Call',
        {executor_id,                   % = 1, {msg,'mesos.v1.ExecutorID'}
         framework_id,                  % = 2, {msg,'mesos.v1.FrameworkID'}
         type,                          % = 3, {enum,'mesos.v1.executor.Call.Type'} (optional)
         subscribe,                     % = 4, {msg,'mesos.v1.executor.Call.Subscribe'} (optional)
         update,                        % = 5, {msg,'mesos.v1.executor.Call.Update'} (optional)
         message                        % = 6, {msg,'mesos.v1.executor.Call.Message'} (optional)
        }).
-endif.
...
-ifndef('MESOS.V1.EXECUTOR.EVENT.MESSAGE_PB_H').
-define('MESOS.V1.EXECUTOR.EVENT.MESSAGE_PB_H', true).
-record('mesos.v1.executor.Event.Message',
        {data                           % = 1, bytes
        }).
-endif.
...
-ifndef('MESOS.V1.EXECUTOR.EVENT.ERROR_PB_H').
-define('MESOS.V1.EXECUTOR.EVENT.ERROR_PB_H', true).
-record('mesos.v1.executor.Event.Error',
        {message                        % = 1, string
        }).
-endif.
...
-ifndef('MESOS.V1.EXECUTOR.EVENT.KILL_PB_H').
-define('MESOS.V1.EXECUTOR.EVENT.KILL_PB_H', true).
-record('mesos.v1.executor.Event.Kill',
        {task_id,                       % = 1, {msg,'mesos.v1.TaskID'}
         kill_policy                    % = 2, {msg,'mesos.v1.KillPolicy'} (optional)
        }).
-endif.

-ifndef('MESOS.V1.EXECUTOR.EVENT.LAUNCH_PB_H').
-define('MESOS.V1.EXECUTOR.EVENT.LAUNCH_PB_H', true).
-record('mesos.v1.executor.Event.Launch',
        {task                           % = 1, {msg,'mesos.v1.TaskInfo'}
        }).
-endif.
...
-ifndef('MESOS.V1.EXECUTOR.EVENT.SUBSCRIBED_PB_H').
-define('MESOS.V1.EXECUTOR.EVENT.SUBSCRIBED_PB_H', true).
-record('mesos.v1.executor.Event.Subscribed',
        {executor_info,                 % = 1, {msg,'mesos.v1.ExecutorInfo'}
         framework_info,                % = 2, {msg,'mesos.v1.FrameworkInfo'}
         agent_info                     % = 3, {msg,'mesos.v1.AgentInfo'}
        }).
-endif.

-ifndef('MESOS.V1.EXECUTOR.EVENT.ACKNOWLEDGED_PB_H').
-define('MESOS.V1.EXECUTOR.EVENT.ACKNOWLEDGED_PB_H', true).
-record('mesos.v1.executor.Event.Acknowledged',
        {task_id,                       % = 1, {msg,'mesos.v1.TaskID'}
         uuid                           % = 2, bytes
        }).
-endif.

-ifndef('MESOS.V1.EXECUTOR.EVENT_PB_H').
-define('MESOS.V1.EXECUTOR.EVENT_PB_H', true).
-record('mesos.v1.executor.Event',
        {type,                          % = 1, {enum,'mesos.v1.executor.Event.Type'} (optional)
         subscribed,                    % = 2, {msg,'mesos.v1.executor.Event.Subscribed'} (optional)
         acknowledged,                  % = 3, {msg,'mesos.v1.executor.Event.Acknowledged'} (optional)
         launch,                        % = 4, {msg,'mesos.v1.executor.Event.Launch'} (optional)
         kill,                          % = 5, {msg,'mesos.v1.executor.Event.Kill'} (optional)
         message,                       % = 6, {msg,'mesos.v1.executor.Event.Message'} (optional)
         error                          % = 7, {msg,'mesos.v1.executor.Event.Error'} (optional)
        }).
-endif.
